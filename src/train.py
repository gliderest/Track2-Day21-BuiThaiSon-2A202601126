...
def train(
    ...
    # Ép MLflow sử dụng thư mục tạm chuẩn xác cho mọi hệ điều hành (Windows/Linux)
    import tempfile
    mlflow.autolog(disable=True)
    temp_mlruns = os.path.join(tempfile.gettempdir(), "mlruns")
    ...
    # TODO 3 & 6: Ghi nhan thong so va chi so vao MLflow (bọc try-except an toàn)
    try:
        ...
        print(f"Bỏ qua log MLflow do lỗi môi trường: {e}")
